...
class Model:
    ...
    def __init__(self): 
        self.model = load('backend\model\sklearn\model_A.pk')
        self.vectorizer = load('backend\__vectorizer\__vectorizer_A.pk')
        self.dictionary = load('backend\dictionary\id_to_category_dict_A.pk')
